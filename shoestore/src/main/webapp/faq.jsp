...
<!-- Mirrored from portotheme.com/html/molla/faq.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Dec 2021 07:22:20 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10 col-lg-9 col-xl-7">
                            <div class="row no-gutters flex-column flex-sm-row align-items-sm-center">
                                ...
                                <div class="col-auto">
                                    <a href="contact.jsp" class="btn btn-outline-white"><span>CONTACT US</span><i class="icon-long-arrow-right"></i></a>
                                </div><!-- End .col-auto -->
