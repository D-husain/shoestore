...
<body>
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <div class="container">
	        	<div class="page-header page-header-big text-center" style="background-image: url('assets/images/demos/demo-10/slider/slide-2.jpg')">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-5 mb-3 mb-lg-0">
                                ...
                                <a href="single.jsp" class="btn btn-sm btn-minwidth btn-outline-primary-2">
                        ...
                        <div class="col-md-4">
                            <div class="member member-anim text-center">
                                <figure class="member-media">
                                    <img src="image/Product/<%=t.getImg()%>" alt="member photo">

                                    <figcaption class="member-overlay">
                                        <div class="member-overlay-content">
                                            <h3 class="member-title"><%=t.getName()%><span><%=t.getPosition()%></span></h3><!-- End .member-title -->
                                            <!-- <p>Sed pretium, ligula sollicitudin viverra, tortor libero sodales leo, eget blandit nunc.</p>  -->
                                            <div class="social-icons social-icons-simple">
                                                <a href="<%=t.getFacebook()%>" class="social-icon" title="Facebook" target="_blank"><i class="icon-facebook-f"></i></a>
                                                <a href="<%=t.getTwitter()%>" class="social-icon" title="Twitter" target="_blank"><i class="icon-twitter"></i></a>
                                                <a href="<%=t.getInstagram()%>" class="social-icon" title="Instagram" target="_blank"><i class="icon-instagram"></i></a>
                                            </div><!-- End .soial-icons -->
...
<!-- Mirrored from portotheme.com/html/molla/about.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 13 Dec 2021 07:22:15 GMT -->
</html>