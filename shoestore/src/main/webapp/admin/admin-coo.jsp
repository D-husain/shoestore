        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="addcoo.php" class="btn btn-primary btn-icon-text">
                    ...
                    <div class="d-flex flex-column flex-lg-row justify-content-lg-end align-items-lg-center  mt-5 mb-2">
                        <div class="d-flex flex-column flex-sm-row justify-content-end align-items-sm-center ">
                            ...
                            <input type="text" class="form-control form-control-sm" style="width: 300px;" id="myInput" placeholder="search" />
                        </div>
                    </div>
                    <div class="px-3">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><img src="countryoforigin/<?php echo $row['image']; ?>" /></td>
                                                <td>
                                                    <a href="editcoo.php?id=<?php echo $row['id']; ?>" class="btn-sm btn-secondary btn-icon-text mr-2 text-decoration-none">Edit
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            You really want to delete <span class='text-primary'><?php echo $row['cat_name']; ?></span> category ?
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                                                            <a href="deletecoo.php?id=<?php echo $row['id']; ?>" type="button" class="btn btn-primary">Yes</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        ?>
                                        <tr>
                                            <th colspan="5"><center>No country of origin yet</center></th>
                                        </tr>
                                    <?php
                                    }
