										...
										<td>
                                         ...
                                         <td>
											...
											%>
                                                ...
                                                <td>
                                                    <a href="ordershipping?id=<%=o.getId()%>" class="btn btn-sm btn-warning text-white btn-icon-text mr-2 text-decoration-none">Shipping
                                                        <i class="typcn typcn-dropbox btn-icon-append"></i>
                                                    </a>
                                                    <button data-toggle="modal" data-target="#cancelmodal<%out.print(oo); %>" class="btn btn-sm btn-danger btn-icon-text text-decoration-none">Cancel
                                            ...
                                            <script>
                                                function validate<%out.print(oo2); %>() {
                                                    let cancelselect<?php echo $row['id']; ?> = document.getElementById('cancelselect<?php echo $row['id']; ?>').value;
                                                    let cancelselecterr<?php echo $row['id']; ?> = document.getElementById('cancelselecterr<?php echo $row['id']; ?>');
                                                    let cancelfield<?php echo $row['id']; ?> = document.getElementById('cancelfield<?php echo $row['id']; ?>').value;
                                                    let cancelfielderr<?php echo $row['id']; ?> = document.getElementById('cancelfielderr<?php echo $row['id']; ?>');
                                                    let mainerr<?php echo $row['id']; ?> = document.getElementById('mainerr<?php echo $row['id']; ?>');

                                                    if (cancelselect<?php echo $row['id']; ?> == "" && cancelfield<?php echo $row['id']; ?> == "") {
                                                        mainerr<?php echo $row['id']; ?>.innerHTML = "Please fillout/select any one field";
                                                        return false
                                                    } else {
                                                        return true
                                                    }
                                                ...
                                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="ordershipping?id=<%=o.getId()%>" type="button" class="btn btn-warning text-white">Shipping</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
