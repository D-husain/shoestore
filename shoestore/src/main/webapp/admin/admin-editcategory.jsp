...
<%
	Category c=(Category)session.getAttribute("c");
%>
<div class="content-wrapper">
    <div class="row">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Edit category : <span class="text-primary"><%=c.getCname()%></span></h4>
                    <form class="forms-sample" action="EditCategory" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <input type="hidden" name="id" value="<%=c.getId()%>"/>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="exampleInputName1">Category Name</label>
                                    <input type="text" name="cname" class="form-control" value="<%=c.getCname()%>" id="catname" placeholder="Category Name" onblur="checkCatName()">
                                    <span id="catnameerr" class="text-danger" style="font-size:14px"></span>
                                </div>
                                
                                <div class="form-group">
                                    <label>Category Image</label>
                                    <input type="file" name="cimage" value="<%=c.getCimage()%>" id="promainimg" class="file-upload-default" onchange="">
                                    <div class="input-group col-xs-12">
                                        <input type="text" value="<%=c.getCimage()%>" id="promainimg-text" class="form-control file-upload-info" disabled placeholder="Upload Category Image">
