                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pname" class="form-control" id="proname" placeholder="Product Name" onblur="">
                        ...
                        %>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" id="prodesc" rows="7" placeholder="Product Description" style="resize:auto" onblur=""></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="info" id="ingredients" rows="7" placeholder="Product Information" style="resize:auto" onblur=""></textarea>
                                    <span id="prodeserr" class="text-danger" style="font-size:14px"></span>
                                </div>
                            </div>
                            <!-- 
                                ...
                                <div class="form-group">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody id="your-father">
                                            <tr>
                                                <td>
                                                    <input type="text" name="qty" class="form-control" id="size1" placeholder="Qty">
                                                ...
                                                <td>
                                                    ...
                                                    <td>
                                                    <input type="text" name="dprice" class="form-control" id="price1" placeholder="Discount Price">
                                                    <span id="priceerr" class="text-danger" style="font-size:14px;margin-top:5px;display:block;"></span>
                                                    </td>
                                            </tr>
                                        </tbody>
