                ...
                <div class="card-body">
                    <h4 class="card-title">Add slider</h4>
                     <%
                        ...
                        %>
                    <form class="forms-sample" action="AddSlider" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="exampleInputName1">Slider Title</label>
                                    <input type="text" name="tital" class="form-control" id="slidertitle" placeholder="Slider Title" onblur="checkslidertitle()">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select name="cname" id="category" class="js-example-basic-single w-100" onchange="checkcategory()">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="content" id="slidercont" onblur="checkslidercont()" rows="7" placeholder="Slider Content" style="resize:auto"></textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="image" id="sliderimg" class="file-upload-default" onchange="checksliderimg()">
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" disabled placeholder="Upload Slider Image">
