        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h6 style="margin:0 auto 20px;">filter orders by date</h6>
                            <form class="forms-sample" action="" id="byDate" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="">From Date</label>
                                            <input type="date" name="from" id="from" class="form-control" placeholder="starting date">
                                            <span class="text-danger" style="font-size:14px;" id="fromerr"></span>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="">To Date</label>
                                            <input type="date" name="to" id="to" class="form-control" placeholder="ending date">
                                            <span class="text-danger" style="font-size:14px;" id="toerr"></span>

                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" onclick="return validate()" class="btn btn-sm btn-primary mr-2">filter</button>
                                        <a href="DownlodeOrder" class="btn btn-sm btn-info">Download</a>
                        ...
                        <div class="col-md-6">
                            <h6 style="margin:0 auto 20px;">Get Sales by period</h6>
                            <form class="forms-sample" action="" id="byPeriod" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="exampleInputName1">Select Period</label>
                                            ...
                                            <span class="text-danger" style="font-size:14px;" id="perioderr"></span>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" onclick="return checkperiod()" class="btn btn-sm btn-primary mr-2">filter</button>
                                        <a href="DownlodeOrder" class="btn btn-sm btn-info">Download</a>
                                        <button type="reset" class="btn btn-sm btn-light">Reset</button>
                                    </div>
                                </div>
                            ...
                            <table class="table table-hover table-striped" id="myTable">
                                ...
                                <tbody>
                                   	<%for(Order o:list){ %>
										...
										<td style="cursor: pointer;" data-toggle="modal" data-target="#detailmodal<%=o.getId()%>"><%=o.getId()%></td>
										<td>
										...
										<td>
                                         ...
                                         <td>
											...
											%>
                                             ...
                                             <td>
											<button data-toggle="modal" data-target="#detailmodal<%=o.getId()%>" class="btn btn-sm btn-secondary btn-icon-text mr-2 text-decoration-none">
                                           ...
                                           <%for(Order o:list){ %>
                                            ...
                                            <%int o3=1; %>
											<%for(Order o:list){ %>		
                                            <div class="modal fade" id="detailmodal<%=o.getId()%>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
...
<script>
    function validate(){
        ...
        let fromerr = document.getElementById('fromerr');
        let to = document.getElementById('to').value;
        let toerr = document.getElementById('toerr');
        if(from == "" && to == ""){
            fromerr.innerHTML = "Please select date";
            toerr.innerHTML = "Please select date";
            return false;
        }
        else if(from == ""){
            fromerr.innerHTML = "Please select date";
    ...
    function checkperiod(){
        ...
        let perioderr = document.getElementById('perioderr');
        if(period == ""){
            perioderr.innerHTML = "Please select the period";
            return false;
        }
        else{
            return true;
