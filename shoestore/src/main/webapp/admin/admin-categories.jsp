        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="admin-addcategory.jsp" class="btn btn-primary btn-icon-text">
                            ...
                            <table class="table table-hover table-striped" id="myTable">
                                ...
                                <tbody>
									...
									<tr>
										...
										<td>
											<img src="image/Product/<%=cat.getCimage()%>"
												alt="image" style="border-radius:0;width:100px;height:50px"/>
										</td>
										<td>
										</td>
										<td>
										<a href="EditCategory?id=<%=cat.getId()%>" class="btn-sm btn-secondary btn-icon-text mr-2 text-decoration-none">Edit
												<i class="typcn typcn-pencil btn-icon-append"></i>
										</a>
											<button data-toggle="modal" data-target="#deletemodal<%out.print(c);%>" class="btn btn-sm btn-danger">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            You really want to delete <span class='text-primary'><%=cat.getCname()%></span> category ?
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                                                            <a href="DeleteCategory?id=<%=cat.getId()%>" type="button" class="btn btn-primary">Yes</a>
                                                        </div>
                                                    </div>
                                               </div>
                                           </div>
