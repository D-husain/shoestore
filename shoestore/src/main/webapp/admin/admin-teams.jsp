        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="admin-addteam.jsp" class="btn btn-primary btn-icon-text">
                    ...
                    <%
						...
						if ("team".equals(msg)) {
					%>
						<div style="background-color:transparent; border-color: transparent;" class="alert alert-warning alert-dismissible fade show"
							role="alert">
							<strong> Team</strong> Delete Successfully.
                            ...
                            <table class="table table-hover table-striped" id="myTable">
                                ...
                                <tbody>
									...
									<tr>
										...
										<td>
											<img src="image/Product/<%=t.getImg()%>"
												alt="image" style="border-radius:0;width:100px;height:50px"/>
										</td>
										<td><a
											href="EditTeam?id=<%=t.getId()%>"
											class="btn-sm btn-secondary btn-icon-text mr-2 text-decoration-none">Edit
												<i class="typcn typcn-pencil btn-icon-append"></i>
										</a>
											<button data-toggle="modal"
												data-target="#deletemodal<%out.print(cat);%>"
									...
									<%
										for(Team t:list){
									%>
									<div class="modal fade" id="deletemodal<%out.print(cat1);%>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            You really want to delete <span class='text-primary'><%=t.getName()%></span> team ?
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">No</button>
                                                            <a href="DeleteTeam?id=<%=t.getId()%>" type="button" class="btn btn-primary">Yes</a>
                                                        </div>
                                                    </div>
                                               </div>
                                           </div>
