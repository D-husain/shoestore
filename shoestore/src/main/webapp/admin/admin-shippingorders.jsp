										...
										<td>
                                         ...
                                         <td>
											...
											%>
                                                ...
                                                <td>
                                                    <a href="orderdeliverd?id=<%=o.getId()%>" class="btn btn-sm btn-success text-white btn-icon-text mr-2 text-decoration-none">Delivered
                                                ...
                                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="orderdeliverd?id=<%=o.getId()%>" type="button" class="btn btn-success">Delived</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
