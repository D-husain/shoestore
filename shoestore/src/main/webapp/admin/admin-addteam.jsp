        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="AddTeam" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    <label for="exampleInputName1">Team Name</label>
                                    <input type="text" id="catname" name="name" class="form-control" placeholder="Category Name" onblur="checkCatName()">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="catname" name="position" class="form-control" placeholder="Category Name" onblur="checkCatName()">
                                    <span id="catnameerr" class="text-danger" style="font-size:14px"></span>
                                </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="file" name="img" id="promainimg" class="file-upload-default" onchange="">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="url" id="catname" name="instagram" class="form-control" placeholder="Category Name" onblur="checkCatName()">
                                    <span id="catnameerr" class="text-danger" style="font-size:14px"></span>
                                </div>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="url" id="catname" name="twitter" class="form-control" placeholder="Category Name" onblur="checkCatName()">
                                    <span id="catnameerr" class="text-danger" style="font-size:14px"></span>
                                </div>
                             ...
                             <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="url" id="catname" name="facebook" class="form-control" placeholder="Category Name" onblur="checkCatName()">
                                    <span id="catnameerr" class="text-danger" style="font-size:14px"></span>
                                </div>
