	                                ...
	                                %>
                                        ...
                                        <td>
											...
											%>
                                                ...
                                                <td>
                                                    <a href="orderactive?id=<%=o.getId()%>" class="btn btn-sm btn-info btn-icon-text mr-2 text-decoration-none">Active
                                                        <i class="typcn typcn-input-checked btn-icon-append"></i>
                                                    </a>
                                                ...
                                                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="orderactive?id=<%=o.getId()%>" type="button" class="btn btn-info">Active</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
