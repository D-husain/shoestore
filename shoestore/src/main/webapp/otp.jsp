        ...
        <main class="main">
			...
			%> 
			    <script type="text/javascript">
					...
					Toast.fire({
					icon: 'error',
					title: '<p style="font-size:15px;">Otp is sent to your <a href="https://accounts.google.com/">Email</a> id</p>'
					})
				</script> 
			<%
			    }
			...
			%>
				<script type="text/javascript">
					...
					Toast.fire({
					icon: 'error',
					title: '<p style="font-size:15px;">Wrong Otp Please Check</p>'
					})
				</script>
			<%
				}
					...
					<div class="tab-pane fade show active" id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
						<form action="UserOtp" method="post">
							<div class="form-group">
								<label for="register-email-2">Enter Your otp</label>
								<input type="tel" onblur="checkemail()" id="otp" class="form-control"
									placeholder="Your otp" name="otp" required>
									<span id='otperr' class='text-danger'></span>
							</div>
							<!-- End .form-group -->
							<div class="form-footer">
								<button type="submit" onclick='return checkvalidate()' class="btn btn-outline-primary-2">
									<span>Verify Otp</span> <i class="icon-long-arrow-right"></i>
								</button>
