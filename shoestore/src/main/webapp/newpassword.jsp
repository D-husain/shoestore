    ...
    <div class="page-wrapper">
        ...
        <main class="main">
           ...
           <%
								...
								Toast.fire({
								  icon: 'error',
								  title: '<p style="font-size:15px;">New & Confirm New Password Does Not Matched</p>'
								})
								</script>
								...
								Toast.fire({
								  icon: 'success',
								  title: '<p style="font-size:15px;">Otp Varify successfully</p>'
								})
								</script>
            		...
            		<div class="form-box">
            			<div class="form-tab">
	            			<ul class="nav nav-pills nav-fill" role="tablist">
							    <li class="nav-item">
							        <a class="nav-link active" id="register-tab-2" data-toggle="tab" href="#register-2" role="tab" aria-controls="register-2" aria-selected="true">New Password</a>
							    </li>
							</ul>
					...
					<div class="tab-pane fade show active" id="register-2" role="tabpanel" aria-labelledby="register-tab-2">
						<form action="NewPassword" method="post">
							<div class="form-group">
								<label for="register-email-2">Enter new Password</label>
								<input type="password" onblur="checknpass()" id="npass" class="form-control"
									placeholder="Your new password" name="npassword" required>
									<span id='npasserr' class='text-danger'></span>
							</div>
							<div class="form-group">
								<label for="register-email-2">Enter confirm Password</label>
								<input type="password" onblur="checkcpass()" id="cpass" class="form-control"
									placeholder="Your confirm password" name="cpassword" required>
							...
							<div class="form-footer">
								<button type="submit" onclick='return checkvalidate()' class="btn btn-outline-primary-2">
									<span>Reset Password</span> <i class="icon-long-arrow-right"></i>
								</button>
