...
/**
 * Servlet implementation class AdminReset
 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(email.equals(email)) {
			...
			try {
				...
				message.setSubject("Admin Reset password");
				message.setContent(""
			...
			dispatcher = request.getRequestDispatcher("admin-otp.jsp?msg=match");
		...
		{
			response.sendRedirect("admin-editprofile.jsp?msg=notmatch");
		}
