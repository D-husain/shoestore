...
public class orderdeliverd extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			message.setSubject("Delivered Order");
			...
			udao.activeDelivered(o);
			
			response.sendRedirect("admin-deliverdorders.jsp");
	...
	private String generateOrderHtml(List<Sproduct> order) {
		...
		String jspContent = "<html>\n" +
		        ...
		        "<h2 class='invoice'>Delivered Order</h2>"+
