...
public class cancelorder extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			response.sendRedirect("admin-cancelledorders.jsp");
	...
	private String generateOrderHtml(List<Sproduct> order) {
		...
		String jspContent = "<html>\n" +
		        "<head>\n" +
		        "<style>"+
		        "body { font-family: Arial, sans-serif; } table { width: 100%; border-collapse: collapse; } th, td { border: 1px solid #ddd; padding: 8px; text-align: left; }.store{color: #445f84; font-family: cursive; text-align: center;}.invoice{ text-align: center; font-family: serif; color: red; } th { background-color: #445f84; }"+
		        "</style>"+
		        "</head>\n" +
		        "<body>\n" +
		        "<div class='store'><h1 class='store'> Shoe Store</h1></div>"+
		        "<h2 class='invoice'>Canceled Order</h2>"+
		        ...
		        "<p style='color: red;'>Order Cancellation Reason: " + cancelorder  + "</p>"+
		        "<table>"+
		        "<tr>"+
		        "<th>ID</th>"+
		        "<th>Product Name</th>"+
