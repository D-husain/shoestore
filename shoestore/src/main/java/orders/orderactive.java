...
public class orderactive extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			message.setSubject("Active Order");
			...
			response.sendRedirect("admin-activeorders.jsp");
	...
	private String generateOrderHtml(List<Sproduct> order) {
		...
		String jspContent = "<html>\n" +
		        ...
		        "<h2 class='invoice'>Active Order</h2>"+
